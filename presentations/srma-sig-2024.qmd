---
title: 'Using GPT API models as second screeners in high-quality systematic reviews'
author: 
 - Mikkel H. Vembye
date: 2024-11-15
event: Systematic Review and Meta-Analysis Special Interest Group Seminar
event_short: SRMA SIG Seminar
event_url: https://www.srmasig.org/seminar/2024-25-seminars/
location: Online
links:
- icon: file-easel
  text: Slides
  url: /files/srma-sig-presentation.pdf
- icon: youtube
  text: Video
  url: https://www.youtube.com/watch?v=FLBTuEFk_eE
- icon: code-slash
  text: Code
  url: https://github.com/MikkelVembye/SRMA-SIG-presentation 
---
